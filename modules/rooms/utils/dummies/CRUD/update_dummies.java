...
public class update_dummies {
	...
	public static void update_suite_dummies () {
		int location1 = -1;
		suite suite1 = null;
			...
			if (location1 != -1) {
				...
				suite1 = (suite)CRUDdummies.update(suite1);
	...
	public static void update_familiar_dummies () {
		int location1 = -1;
		...
		familiar1 = (familiar)CRUDdummies.create_llave_primaria(1);
			...
			if (location1 != -1) {
				...
				familiar1 = (familiar)CRUDdummies.update(familiar1);
	...
	public static void update_doble_dummies () {
		int location1 = -1;
		doble doble1 = null;
		...
		doble1 = (doble)CRUDdummies.create_llave_primaria(2);
			...
			if (location1 != -1) {
				...
				doble1 = (doble)CRUDdummies.update(doble1);
